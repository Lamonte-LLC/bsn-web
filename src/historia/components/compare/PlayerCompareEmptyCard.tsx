...
import { setPickerOpen, useCompareNavigation, useCompareState } from './useCompareState';
...
export default function PlayerCompareEmptyCard({ selectedKeys, suggested, seasonName }: Props) {
  ...
  return (
    <div className="relative rounded-[16px] border border-[rgba(15,23,31,0.06)] bg-white px-[16px] pb-[20px] pt-[22px] shadow-[0_12px_32px_rgba(15,23,31,0.08)] lg:px-[44px] lg:pb-[30px] lg:pt-[34px]">
      <ComparePendingBar active={pending} />
