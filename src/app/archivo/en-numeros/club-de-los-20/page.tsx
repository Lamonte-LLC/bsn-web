...
export default function ClubDeLos20Page() {
  ...
  return (
    <InsightPage title="El club de los 20" context="En los setenta, promediar treinta era posible. Hoy, veinte es una hazaña." heroNumber={data.byThreshold['20']?.length ?? 0} heroNumberLabel="temporadas de 20 o más puntos por juego">
